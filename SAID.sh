...
$ce[$ve 05$re ]$am Hacer Spam  por SMS $re
"
echo
...
05)
	...
	clear
	printf "
$az[$ve+$az]$ce Listo, cada vez que quieras hacer spam solo coloca el comando$am said spam

$ve en el primer espacio :$az coloca el numero de tu victima
$ve en el segundo espacio:$az cantidad de mensajes a enviar
$ve en el tercer espacio :$az los segundos de espera entre sms$re"
;;
spam)
	cd
	cd spammee
